...
import (
	...
	mockUtils "github.com/fadilahonespot/superindo/utils"
...
func TestProductHandler_AddProduct(t *testing.T) {
	...
	tests := []struct {
		name              string
		createProductResp dto.CreateProductResponse
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			productUsecase.On("CreateProduct", mock.Anything, mock.Anything).Return(tt.createProductResp, tt.createProductErr).Once()
